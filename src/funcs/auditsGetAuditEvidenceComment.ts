 ...
 */
export function auditsGetAuditEvidenceComment(
  client: VantaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAuditEvidenceCommentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc(
    "/audits/{auditId}/evidence/{auditEvidenceId}/comments/{commentId}",
  )(pathParams);
