 ...
 */
export function auditsUpdateCommentForControl(
  client: VantaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateCommentForControlRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateAuditControlCommentInput, {
    explode: true,
  });
