...
export function auditsListInformationRequestActivity(
  ...
  Result<
    components.PaginatedResponseInformationRequestActivityLog,
    | VantaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInformationRequestActivityRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      components.PaginatedResponseInformationRequestActivityLog$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
