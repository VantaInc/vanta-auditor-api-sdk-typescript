 ...
 */
export function auditsDeleteCommentForControl(
  client: VantaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCommentForControlRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DeleteAuditControlCommentInput, {
    explode: true,
  });
