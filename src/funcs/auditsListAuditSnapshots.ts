 ...
 */
export function auditsListAuditSnapshots(
  client: VantaCore,
  request: operations.ListAuditSnapshotsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PaginatedIssueSnapshotMetadataResponse,
    | VantaError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAuditSnapshotsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/audits/{auditId}/issues/snapshots")(pathParams);
  ...
  >(
    M.json(
      200,
      components.PaginatedIssueSnapshotMetadataResponse$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
