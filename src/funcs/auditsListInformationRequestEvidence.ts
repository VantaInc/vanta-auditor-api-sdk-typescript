...
export function auditsListInformationRequestEvidence(
  ...
  Result<
    components.PaginatedResponseInformationRequestEvidence,
    | VantaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListInformationRequestEvidenceRequest$outboundSchema.parse(
        value,
      ),
  ...
  const query = encodeFormQuery({
    ...
    "evidenceTypeMatchesAny": payload.evidenceTypeMatchesAny,
  ...
  >(
    M.json(
      200,
      components.PaginatedResponseInformationRequestEvidence$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
