...
export function auditsListCommentsForInformationRequest(
  ...
  Result<
    components.PaginatedResponseInformationRequestComment,
    | VantaError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListCommentsForInformationRequestRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      components.PaginatedResponseInformationRequestComment$inboundSchema,
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
