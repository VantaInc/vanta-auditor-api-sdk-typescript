 ...
 */
export function auditsDeleteCommentForInformationRequest(
  client: VantaCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCommentForInformationRequestRequest$outboundSchema.parse(
        value,
      ),
  ...
  const body = encodeJSON(
    "body",
    payload.DeleteInformationRequestCommentInput,
    { explode: true },
  );
