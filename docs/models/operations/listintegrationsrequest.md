...
| `tagsMatchesAny`                                                                             | [components.AuditIntegrationTag](../../models/components/auditintegrationtag.md)[]           | :heavy_minus_sign:                                                                           | Filter integrations by tag values                                                            |
| `categoriesMatchesAny`                                                                       | [components.AuditIntegrationCategory](../../models/components/auditintegrationcategory.md)[] | :heavy_minus_sign:                                                                           | Filter integrations by category values                                                       |