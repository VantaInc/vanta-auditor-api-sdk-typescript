...
```typescript
import { ListAuditSnapshotsRequest } from "vanta-auditor-api-sdk/models/operations";

let value: ListAuditSnapshotsRequest = {
  auditId: "<id>",
};
```
...
| `search`                                                    | *string*                                                    | :heavy_minus_sign:                                          | Search term for filtering by snapshot title and description |