...
| `tags`                                                                        | *string*[]                                                                    | :heavy_minus_sign:                                                            | Integration tag display names describing what data this integration provides. | [<br/>"Vulnerabilities",<br/>"Code changes"<br/>]                             |
| `categories`                                                                  | *string*[]                                                                    | :heavy_minus_sign:                                                            | Category display names describing what the integration is used for.           | [<br/>"Version control systems"<br/>]                                         |