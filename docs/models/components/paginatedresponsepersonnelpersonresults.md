...
```typescript
import { PaginatedResponsePersonnelPersonResults } from "vanta-auditor-api-sdk/models/components";

let value: PaginatedResponsePersonnelPersonResults = {
  data: [
    {
...
| -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| `data`                                                                     | [components.PersonnelPerson](../../models/components/personnelperson.md)[] | :heavy_check_mark:                                                         | N/A                                                                        |
