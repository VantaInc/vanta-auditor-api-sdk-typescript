# AuditIntegrationServiceCategory

## Example Usage

```typescript
import { AuditIntegrationServiceCategory } from "vanta-auditor-api-sdk/models/components";

let value: AuditIntegrationServiceCategory = "DATA_WAREHOUSE_PROVIDER";
```
